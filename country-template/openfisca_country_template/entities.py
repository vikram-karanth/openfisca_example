...
Shipment = build_entity(
    ...
    plural = "shipments",
    doc = """
    Shipment related documentation.
    """,
    label = "A Shipment. The minimal entity on which oyster movement rules can be applied.",
    roles = [{
                "key": "source_estuary",
                "plural": "source_estuaries",
                "label": "Source Estuary",
                "max": 2,
                # "subroles": ["source_estuary", "destination_estuary"],
                "doc": "The source estuaries for oyster movement.",
            },{
                "key": "destination_estuary",
                "plural": "destination_estuaries",
                "label": "Destination Estuary",
                "max": 2,
                # "subroles": ["source_estuary", "destination_estuary"],
